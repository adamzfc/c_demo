...
int main (int argc, char **argv)
{
    ...
    */
    ...
    printf ("x86-64 code generation starting...\n");
    Stack2x86_64_print (stack);
    printf ("x86-64 code generation finished (writing to file \"temp.s\")\n");
    //system("cat temp.s");

    printf ("executable generation starting...\n");
    system ("gcc -o ./stack.out ./temp.s");
